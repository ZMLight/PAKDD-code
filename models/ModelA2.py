...
class Tunnel(chainer.Chain):
	...
	"""
	def __call__(self,x,neighbor_entities,neighbor_dict,assign,entities,relations,RC,EC):
		if self.layer==0:
...
class Model(chainer.Chain):
	...
	def get_context(self,entities,links,relations,edges,order,xp,RC,EC):
		...
		x = getattr(self,self.forwardB[order][0])(x,neighbor,neighbor_dict,assign,entities,relations,RC,EC)
		return x
